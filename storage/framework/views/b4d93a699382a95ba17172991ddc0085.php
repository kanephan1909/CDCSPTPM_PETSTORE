...
<div class="banner">
    ...
    <div class="banner-top">
        <a href="#" class="banner-top-2-child">
            <img src="<?php echo e(asset('frontend/img/bgv1.jpg')); ?>" alt="Pet Store">
            <div class="text">Pet Store thú cưng</div>
        </a>

        <a href="#" class="banner-top-2-child">
            <img src="<?php echo e(asset('frontend/img/bgv2.jpg')); ?>" alt="Pet Hotel">
            <div class="text">Pet Hotel khách sạn cho thú cưng</div>
        </a>

        <a href="#" class="banner-top-2-child">
            <img src="<?php echo e(asset('frontend/img/bgv3.jpg')); ?>" alt="Pet Grooming">
            <div class="text">Pet Grooming spa dành cho thú cưng</div>
        </a>

        <a href="#" class="banner-top-2-child">
            <img src="<?php echo e(asset('frontend/img/bgv4.jpg')); ?>" alt="Exclusive Products">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pkhan\OneDrive\Desktop\CDCS_2200008424_PhanLamNhatKhang\shopthucung_laravel\shopthucung_laravel\resources\views/pages/home.blade.php ENDPATH**/ ?>